...
export const Globe = memo(() => {
	...
	const handleButtonClick = useCallback(() => router.push('/chats'), [router]);
			...
			<div className='max-w-7xl mx-auto w-full relative overflow-hidden h-full '>
				...
				>
					...
					>
						...
						<p
							className={cn(
								'text-center text-lg md:text-2xl font-normal text-neutral-200',
				...
				<div className='absolute w-full -bottom-24 h-full z-10'>
					<World
						data={sampleArcs}
